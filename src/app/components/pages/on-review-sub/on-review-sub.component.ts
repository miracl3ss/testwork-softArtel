...
@Component({
  selector: 'app-on-review-sub',
  imports: [DropdownListComponent],
  templateUrl: './on-review-sub.component.html',
  styleUrl: './on-review-sub.component.scss'
})
export class OnReviewSubComponent implements OnInit, OnChanges{
myTasks: any[] = [];
    pausedTasks: any[] = [];
    unassignedTasks: any[] = [];
