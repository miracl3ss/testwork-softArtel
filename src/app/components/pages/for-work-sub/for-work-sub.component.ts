...
@Component({
  selector: 'app-for-work-sub',
  imports: [DropdownListComponent],
  templateUrl: './for-work-sub.component.html',
  styleUrl: './for-work-sub.component.scss'
})
export class ForWorkSubComponent implements OnInit, OnChanges {
myTasks: any[] = [];
    pausedTasks: any[] = [];
    unassignedTasks: any[] = [];
